...
<!-- 								{{-- VIEW TASK PROFILE ICON BUTTON --}}
								<a href="{{ route('profile.show', $a_task->id) }}" class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect" title="View User Profile">
									<i class="material-icons">person_outline</i>
								</a>


								{{-- VIEW TASK ACCOUNT ICON BUTTON --}}
								<a href="{{ URL::to('tasks/' . $a_task->id) }}" class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect" title="View User Account">
