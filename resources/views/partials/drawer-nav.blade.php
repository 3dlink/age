	...
	<nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
		...
		@if (!Auth::guest() && Auth::user()->hasRole('super administrador'))
			...
			<a class="mdl-navigation__link" href="{{ url('/subject') }}">
				<i class="mdl-color-text--blue-grey-400 material-icons mdl-badge mdl-badge--overlap" role="presentation">subject</i>
				Subjects List
			</a>
...
<!-- 			<a class="mdl-navigation__link" href="{{ url('/users/create') }}">
		...
		@if (!Auth::guest() && Auth::user()->hasRole('super administrador') || Auth::user()->hasRole('supervisor') || Auth::user()->hasRole('analista'))
			<a class="mdl-navigation__link" href="{{ url('/task') }}">
				<i class="mdl-color-text--blue-grey-400 material-icons mdl-badge mdl-badge--overlap" role="presentation">list</i>
				Tasks List
			</a>
		@endif

			<a class="mdl-navigation__link" href="{{ url('/report') }}">
				<i class="mdl-color-text--blue-grey-400 material-icons mdl-badge mdl-badge--overlap" role="presentation">description</i>
				Reports List
			</a>
